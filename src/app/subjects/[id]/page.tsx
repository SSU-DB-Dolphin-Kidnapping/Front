...
const SubjectDetail = ({ params }: { params: Promise<{ id: string }> }) => {
        ...
        <div className="animate-fade-in">
            <div className="object-header">
                <div className="container">
                    <button onClick={() => router.back()} className="btn btn-secondary" style={{ marginBottom: '1rem', border: 'none', paddingLeft: 0 }}>
                        ← 뒤로가기
                    </button>
